module.exports = RED => {
    ...
    function jsftpdServerNode(n) {
        ...
        async function uploadHandler(user, path, filename, content, offset) {
            node.broadcast('upload', {user: user, path: path, filename: filename, content: content, offset: offset})
            return true
        }
